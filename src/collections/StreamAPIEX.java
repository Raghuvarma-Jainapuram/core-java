...
//		Object ascendingEname = al.stream().sorted().collect(Collectors.toList()); 
//		System.out.println("Ename in Ascending order: "+ascendingEname);
		
//		List<Emp> result = al.stream().sorted().collect(Collectors.toList());
//		System.out.println("Ename in Ascending order: "+result);
	}
